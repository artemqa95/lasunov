...
exports.BlockFromType = exports.ColumnsBlock = exports.TextBlock = exports.ImageBlock = exports.TitleBlock = void 0;
...
var Block = function Block(value, options) {
...
var ColumnsBlock = /*#__PURE__*/function (_Block4) {
  ...
  _createClass(ColumnsBlock, [{
    ...
    value: function toHTML() {
      ...
      var html = typeof this.value === "string" ? this.value.split("@").map(_utils.col) : this.value.map(_utils.col);
...
var BlockFromType = /*#__PURE__*/function (_Block5) {
  _inherits(BlockFromType, _Block5);

  var _super5 = _createSuper(BlockFromType);

  function BlockFromType(value, options) {
    _classCallCheck(this, BlockFromType);

    return _super5.call(this, value, options);
  }

  _createClass(BlockFromType, [{
    key: "text",
    get: function get() {
    ...
    key: "image",
    get: function get() {
      return new ImageBlock(this.value, this.options);
    }
  }, {
    key: "columns",
    get: function get() {
      return new ColumnsBlock(this.value, this.options);
    }
  }, {
    key: "title",
    get: function get() {
  ...
  return BlockFromType;
}(Block);

exports.BlockFromType = BlockFromType;
...
}), new _blocks.TextBlock("Ласунов Артём (sl1d3z0r@gmail.com)", {
  styles: {
...
}), new _blocks.ColumnsBlock(['Приложение на чистом JS', 'Используются принципы ООП', 'Сборка через бандлер Parcel'], {
  styles: {
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    value: function add(event) {
      ...
      var newBlock = new _blocks.BlockFromType(value, {
        styles: styles
      })[type];
